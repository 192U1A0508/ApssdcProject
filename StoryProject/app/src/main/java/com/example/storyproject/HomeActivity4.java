...
public class HomeActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cnt=findViewById(R.id.cranecontent);
        ...
        playPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(HomeActivity4.this,"playing...",Toast.LENGTH_SHORT).show();
            }
    ...
    public void stop(View view) {
        if(t1!=null){
            t1.stop();
            Toast.makeText(HomeActivity4.this, "Stopped...", Toast.LENGTH_SHORT).show();
