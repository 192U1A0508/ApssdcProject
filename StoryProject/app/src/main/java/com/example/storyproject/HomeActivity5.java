...
public class HomeActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cnt=findViewById(R.id.wealthcontent);
        ...
        playPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(HomeActivity5.this,"playing...",Toast.LENGTH_SHORT).show();
            }
    ...
    public void stop(View view) {
        if(t1!=null){
            t1.stop();
            Toast.makeText(HomeActivity5.this, "Stopped...", Toast.LENGTH_SHORT).show();
